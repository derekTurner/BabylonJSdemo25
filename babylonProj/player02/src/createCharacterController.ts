...
// global code for character controller 
...
export function createCharacterController(scene: Scene) {
    ...
    displayCapsule.position = new Vector3(0, h / 2, 0); // Position capsule at starting point

    let characterPosition = new Vector3(0, h / 2, 0); // Start at center of ground
